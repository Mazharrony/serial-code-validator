 ...
 * Activation hook.
 */
function activate_serial_validator() {
 ...
 * Deactivation hook.
 */
function deactivate_serial_validator() {
    require_once SERIAL_VALIDATOR_PLUGIN_DIR . 'includes/class-deactivator.php';
    Serial_Validator_Deactivator::deactivate();
}

register_activation_hook(__FILE__, 'activate_serial_validator');
register_deactivation_hook(__FILE__, 'deactivate_serial_validator');
